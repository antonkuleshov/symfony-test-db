...
class DepartmentsController extends AbstractController
{
    ...
    /**
     * @Route("/{deptNo}", name="departments_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{deptNo}/edit", name="departments_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{deptNo}", name="departments_delete", methods={"DELETE"})
     */
